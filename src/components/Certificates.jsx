...
import certImage1 from "../../src/assets/certificate1.png"; // certificate1 image here
import certImage2 from "../../src/assets/certificate2.jpg"; // certificate2 image here
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center ">
          ...
          >
            <img
              src={certImage1}
              alt="Certificate"
              className="rounded-xl shadow-[0_0_30px_rgba(20,184,166,0.5)] border border-teal-400/30 hover:scale-105 transition duration-300 mb-6"
            />
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 mb-4">
              This certification validates my proficiency in Advanced Topics of SQL like window functions, complex joins, Time Series etc.
            </p>

            <p className="text-gray-400 mb-6">
              Issued by: HackerRank <br />
              Year: 2026
            </p>

            <a
              href="https://www.hackerrank.com/certificates/iframe/aba8acc17fb8"
              target="_blank"
